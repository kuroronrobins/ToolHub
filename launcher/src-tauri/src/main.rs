...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            app_studio_commands::app_studio_lifecycle_list_apps,
            app_studio_commands::app_studio_lifecycle_set_enabled,
            app_studio_commands::app_studio_lifecycle_soft_delete,
            app_studio_commands::app_studio_lifecycle_list_backups,
            app_studio_commands::app_studio_lifecycle_restore_backup,
