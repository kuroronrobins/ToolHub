...
mod app_studio_delete_plan;
mod app_studio_full_delete;
mod app_studio_management;
mod app_studio_overrides;
mod app_studio_preflight;
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::check_updates_remote,
            commands::download_update_installer,
            commands::launch_verified_update_installer,
            commands::get_update_result_log,
            ...
            app_studio_commands::app_studio_publish_suggest_release_notes,
