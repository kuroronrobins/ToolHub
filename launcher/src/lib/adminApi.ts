...
import type { AdminSessionStatus, AiConnectionTestResult, AiImageGenerationTestResult, AiImageModelProbeResult, AiSettings, ApiKeyStatus } from "./adminTypes";
...
export async function aiProbeImageModels(): Promise<AiImageModelProbeResult> {
  return invoke<AiImageModelProbeResult>("ai_probe_image_models");
}
